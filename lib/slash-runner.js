...
function slashRunner(token, options) {
    this.token = token;
...
slashRunner.prototype.handle = function (req, cb) {
...
slashRunner.prototype._getJiraIssue = function (issueId, cb) {
    var self = this;
...
slashRunner.prototype._swapDisplayName = function (name) {
...
slashRunner.prototype._createSlackMessage = function (jiraRes) {
